...
public class DBServiceHibernateImplTest {
    ...
    public void saveTest(){
        ...
        service.save(new UserDataSet("John Doe",34,new AddressDataSet("Leninskiy,100"),list));
        service.save(new UserDataSet("Sam One",25,new AddressDataSet("Aeroport,123"),new ArrayList<>()));
        Assert.assertEquals("save failed","Sam One", service.load(2,UserDataSet.class).getName());
    }

    @Test
    public void loadTest(){
        service.save(new UserDataSet("John Doe",34,new AddressDataSet("Leninskiy,100"),new ArrayList<>()));
        service.save(new UserDataSet("Sam One",25,new AddressDataSet("Aeroport,123"),new ArrayList<>()));
